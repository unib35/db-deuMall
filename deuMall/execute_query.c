...
55,0,0,3,0,0,30,65,0,0,0,0,0,1,0,
70,0,0,4,0,0,17,83,0,0,1,1,0,1,0,1,97,0,0,
89,0,0,4,0,0,45,85,0,0,0,0,0,1,0,
104,0,0,4,0,0,13,88,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
131,0,0,5,0,0,17,123,0,0,1,1,0,1,0,1,97,0,0,
150,0,0,5,0,0,45,125,0,0,0,0,0,1,0,
165,0,0,5,0,0,13,129,0,0,5,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
200,0,0,6,0,0,17,162,0,0,1,1,0,1,0,1,97,0,0,
219,0,0,6,0,0,45,164,0,0,0,0,0,1,0,
234,0,0,6,0,0,13,168,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
261,0,0,7,0,0,31,197,0,0,0,0,0,1,0,
};
...
struct ItemsDto *select_ItemList(){
    ...
    /* varchar item_id[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } item_id;
...
struct { unsigned short len; unsigned char arr[100]; } price;
    ...
    /* varchar stock[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } stock;

    /* varchar description[250]; */ 
struct { unsigned short len; unsigned char arr[250]; } description;
...

{
        ...
        sqlstm.sqhstv[4] = (         void  *)&description;
        sqlstm.sqhstl[4] = (unsigned int  )252;
